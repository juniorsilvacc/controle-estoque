...
<div class="col-md-12 form-group">
    ...
    <input type="text" class="form-control" id="nome_usuario" name="nome_usuario"
        value="{{ $usuario->nome_usuario ?? old('nome_usuario') }}" disabled>
</div>
...
<div class="col-md-6 form-group">
    ...
    <input type="text" class="form-control" id="telefone" name="telefone"
        value="{{ $usuario->telefone ?? old('telefone') }}" disabled>
</div>
<div class="col-md-6 form-group ">
    <label for="data_nascimento" class="small">Data de Nascimento</label>
    <input type="date" class="form-control" id="data_nascimento" name="data_nascimento"
        value="{{ $usuario->data_nascimento ?? old('data_nascimento') }}" disabled>
</div>
